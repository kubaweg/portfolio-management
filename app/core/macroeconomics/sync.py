...
def sync_inflation_data(df_infl: pd.DataFrame) -> int:
    ...
    with SessionLocal() as db:
        try:
            ...
            existing_records = db.query(Inflation.month).all()
...
def sync_interest_rates(df_rates: pd.DataFrame) -> int:
    ...
    with SessionLocal() as db:
        try:
            ...
            existing_records = db.query(InterestRate.effective_date).all()
